                                ...
                                <div class="col mb-3">
                                    <div class="card">
                                        <div class="card-body d-flex">
                                            @if($macbook->series == 'Macbook m1')
                                                <img src="{{ asset('images/macbook1.jpg') }}" alt="Macbook m1"
                                                    style="width: 100%; object-fit: cover; height: 350px; margin: 0 auto; border-radius: 12px;">
                                            @elseif($macbook->series == 'Macbook m2')
                                                <img src="{{ asset('images/macbook2.jpg') }}" alt="Macbook m2"
                                                    style="width: 100%; object-fit: cover; height: 350px; margin: 0 auto; border-radius: 12px;">
                                            @elseif($macbook->series == 'Macbook m3')
                                                <img src="{{ asset('images/macbook3.jpg') }}" alt="Macbook m3"
                                                    style="width: 100%; object-fit: cover; height: 350px; margin: 0 auto; border-radius: 12px;">
                                            @elseif($macbook->series == 'Macbook m4')
                                                <img src="{{ asset('images/macbook4.jpg') }}" alt="Macbook m4"
                                                    style="width: 100%; object-fit: cover; height: 350px; margin: 0 auto; border-radius: 12px;">
                                            @elseif($macbook->series == 'Macbook m5')
                                                <img src="{{ asset('images/macbook5.jpg') }}" alt="Macbook m5"
                                                    style="width: 100%; object-fit: cover; height: 350px; margin: 0 auto; border-radius: 12px;">
                                            @endif
                                        </div>
                                        <p class="card-title my-2 mx-4 text-center" style="font-weight: bold; font-size: 24px;">{{ $macbook->series }}</p>
                                        <p class="card-title mx-4 text-center" style="text-align:center; font-size: 16px;">IDR <?php echo number_format($macbook->price, 0, ',', '.'); ?> </p>
                                    </div>
                                </div>
                            @endforeach
                        </div>
